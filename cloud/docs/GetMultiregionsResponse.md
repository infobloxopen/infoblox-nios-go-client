...
`func (o *GetMultiregionsResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetMultiregionsResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetMultiregionsResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetMultiregionsResponse) HasUuid() bool`
