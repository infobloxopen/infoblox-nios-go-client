...
`func (o *GetDhcpStatisticsResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDhcpStatisticsResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDhcpStatisticsResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDhcpStatisticsResponse) HasUuid() bool`
