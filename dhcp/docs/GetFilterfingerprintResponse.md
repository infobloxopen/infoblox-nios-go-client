...
`func (o *GetFilterfingerprintResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetFilterfingerprintResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetFilterfingerprintResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetFilterfingerprintResponse) HasUuid() bool`
