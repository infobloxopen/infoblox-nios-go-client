...
`func (o *GetFilterfingerprintResponse) GetExtAttrsMinus() map[string]ExtAttrsMinus`

GetExtAttrsMinus returns the ExtAttrsMinus field if non-nil, zero value otherwise.

### GetExtAttrsMinusOk

`func (o *GetFilterfingerprintResponse) GetExtAttrsMinusOk() (*map[string]ExtAttrsMinus, bool)`
...
`func (o *GetFilterfingerprintResponse) SetExtAttrsMinus(v map[string]ExtAttrsMinus)`
