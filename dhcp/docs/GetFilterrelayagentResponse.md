...
`func (o *GetFilterrelayagentResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetFilterrelayagentResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetFilterrelayagentResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetFilterrelayagentResponse) HasUuid() bool`
