...
`func (o *GetFingerprintResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetFingerprintResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetFingerprintResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetFingerprintResponse) HasUuid() bool`
