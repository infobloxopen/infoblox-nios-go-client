...
`func (o *GetFixedaddresstemplateResponse) GetExtAttrsPlusOk() (*map[string]ExtAttrs, bool)`
...
`func (o *GetFixedaddresstemplateResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetFixedaddresstemplateResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetFixedaddresstemplateResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetFixedaddresstemplateResponse) HasUuid() bool`
