...
`func (o *GetIpv6filteroptionResponse) GetExtAttrsMinus() map[string]ExtAttrs`

GetExtAttrsMinus returns the ExtAttrsMinus field if non-nil, zero value otherwise.

### GetExtAttrsMinusOk

`func (o *GetIpv6filteroptionResponse) GetExtAttrsMinusOk() (*map[string]ExtAttrs, bool)`
...
`func (o *GetIpv6filteroptionResponse) SetExtAttrsMinus(v map[string]ExtAttrs)`

SetExtAttrsMinus sets ExtAttrsMinus field to given value.

### HasExtAttrsMinus

`func (o *GetIpv6filteroptionResponse) HasExtAttrsMinus() bool`
