...
`func (o *GetMacfilteraddressResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetMacfilteraddressResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetMacfilteraddressResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetMacfilteraddressResponse) HasUuid() bool`
