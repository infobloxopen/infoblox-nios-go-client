...
func (r DiscoveryDiagnostictaskAPIListRequest) ReturnFields2(returnFields2 string) DiscoveryDiagnostictaskAPIListRequest {
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r DiscoveryDiagnostictaskAPIReadRequest) ReturnFields2(returnFields2 string) DiscoveryDiagnostictaskAPIReadRequest {
	r.returnFields2 = &returnFields2
	return r
}
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r DiscoveryDiagnostictaskAPIUpdateRequest) ReturnFields2(returnFields2 string) DiscoveryDiagnostictaskAPIUpdateRequest {
	r.returnFields2 = &returnFields2
	return r
}
