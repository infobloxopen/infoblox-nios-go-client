...
**Index** | Pointer to **string** | The interface index number, as reported by SNMP. | [optional] [readonly] 
...
`func (o *GetDiscoveryDeviceinterfaceResponse) GetIndex() string`

GetIndex returns the Index field if non-nil, zero value otherwise.

### GetIndexOk

`func (o *GetDiscoveryDeviceinterfaceResponse) GetIndexOk() (*string, bool)`
...
`func (o *GetDiscoveryDeviceinterfaceResponse) SetIndex(v string)`
