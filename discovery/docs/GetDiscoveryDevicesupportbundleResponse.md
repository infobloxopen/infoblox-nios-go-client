...
`func (o *GetDiscoveryDevicesupportbundleResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDiscoveryDevicesupportbundleResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDiscoveryDevicesupportbundleResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDiscoveryDevicesupportbundleResponse) HasUuid() bool`
