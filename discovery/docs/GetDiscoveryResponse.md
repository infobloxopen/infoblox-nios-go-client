...
`func (o *GetDiscoveryResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDiscoveryResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDiscoveryResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDiscoveryResponse) HasUuid() bool`
