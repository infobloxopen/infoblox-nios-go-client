...
`func (o *GetDiscoveryStatusResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDiscoveryStatusResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDiscoveryStatusResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDiscoveryStatusResponse) HasUuid() bool`
