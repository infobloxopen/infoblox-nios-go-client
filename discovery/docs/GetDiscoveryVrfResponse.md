...
`func (o *GetDiscoveryVrfResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDiscoveryVrfResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDiscoveryVrfResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDiscoveryVrfResponse) HasUuid() bool`
