...
type AllnsgroupAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a allnsgroup object

		Use PUT call as GET operation with _method for a Struct field of a allnsgroup object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return AllnsgroupAPIPutRequest
	*/
	Put(ctx context.Context) AllnsgroupAPIPutRequest

	// PutExecute executes the request
	//  @return ListAllnsgroupResponse
	PutExecute(r AllnsgroupAPIPutRequest) (*ListAllnsgroupResponse, *http.Response, error)
	/*
...
type AllnsgroupAPIPutRequest struct {
	ctx            context.Context
	ApiService     AllnsgroupAPI
...
func (r AllnsgroupAPIPutRequest) Allnsgroup(allnsgroup Allnsgroup) AllnsgroupAPIPutRequest {
	r.allnsgroup = &allnsgroup
	return r
}

// Enter the field names followed by comma
func (r AllnsgroupAPIPutRequest) ReturnFields(returnFields string) AllnsgroupAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r AllnsgroupAPIPutRequest) ReturnFields2(returnFields2 string) AllnsgroupAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r AllnsgroupAPIPutRequest) ReturnAsObject(returnAsObject int32) AllnsgroupAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r AllnsgroupAPIPutRequest) MaxResults(maxResults int32) AllnsgroupAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r AllnsgroupAPIPutRequest) Method(method string) AllnsgroupAPIPutRequest {
	r.method = &method
	return r
}

func (r AllnsgroupAPIPutRequest) Execute() (*ListAllnsgroupResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a allnsgroup object
	...
	@return AllnsgroupAPIPutRequest
*/
func (a *AllnsgroupAPIService) Put(ctx context.Context) AllnsgroupAPIPutRequest {
	return AllnsgroupAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListAllnsgroupResponse
func (a *AllnsgroupAPIService) PutExecute(r AllnsgroupAPIPutRequest) (*ListAllnsgroupResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "AllnsgroupAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
	...
	localVarFormParams := url.Values{}
	if r.allnsgroup == nil {
		return localVarReturnValue, nil, internal.ReportError("allnsgroup is required and must be specified")
	}
