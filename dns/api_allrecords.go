...
func (r AllrecordsAPIListRequest) ReturnFields2(returnFields2 string) AllrecordsAPIListRequest {
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r AllrecordsAPIReadRequest) ReturnFields2(returnFields2 string) AllrecordsAPIReadRequest {
	r.returnFields2 = &returnFields2
	return r
}
