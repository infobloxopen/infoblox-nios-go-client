...
type AllrecordsAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a allrecords object

		Use PUT call as GET operation with _method for a Struct field of a allrecords object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return AllrecordsAPIPutRequest
	*/
	Put(ctx context.Context) AllrecordsAPIPutRequest

	// PutExecute executes the request
	//  @return ListAllrecordsResponse
	PutExecute(r AllrecordsAPIPutRequest) (*ListAllrecordsResponse, *http.Response, error)
	/*
...
type AllrecordsAPIPutRequest struct {
	ctx            context.Context
	ApiService     AllrecordsAPI
...
func (r AllrecordsAPIPutRequest) Allrecords(allrecords Allrecords) AllrecordsAPIPutRequest {
	r.allrecords = &allrecords
	return r
}

// Enter the field names followed by comma
func (r AllrecordsAPIPutRequest) ReturnFields(returnFields string) AllrecordsAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r AllrecordsAPIPutRequest) ReturnFields2(returnFields2 string) AllrecordsAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r AllrecordsAPIPutRequest) ReturnAsObject(returnAsObject int32) AllrecordsAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r AllrecordsAPIPutRequest) MaxResults(maxResults int32) AllrecordsAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r AllrecordsAPIPutRequest) Method(method string) AllrecordsAPIPutRequest {
	r.method = &method
	return r
}

func (r AllrecordsAPIPutRequest) Execute() (*ListAllrecordsResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a allrecords object
	...
	@return AllrecordsAPIPutRequest
*/
func (a *AllrecordsAPIService) Put(ctx context.Context) AllrecordsAPIPutRequest {
	return AllrecordsAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListAllrecordsResponse
func (a *AllrecordsAPIService) PutExecute(r AllrecordsAPIPutRequest) (*ListAllrecordsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "AllrecordsAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
	...
	localVarFormParams := url.Values{}
	if r.allrecords == nil {
		return localVarReturnValue, nil, internal.ReportError("allrecords is required and must be specified")
	}
