...
type RecordaAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a record:a object

		Use PUT call as GET operation with _method for a Struct field of a record:a object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return RecordaAPIPutRequest
	*/
	Put(ctx context.Context) RecordaAPIPutRequest

	// PutExecute executes the request
	//  @return ListRecordAResponse
	PutExecute(r RecordaAPIPutRequest) (*ListRecordAResponse, *http.Response, error)
	/*
...
type RecordaAPIPutRequest struct {
	ctx            context.Context
	ApiService     RecordaAPI
	recordA        *RecordA
	returnFields   *string
...
// Object data to create
func (r RecordaAPIPutRequest) RecordA(recordA RecordA) RecordaAPIPutRequest {
	r.recordA = &recordA
	return r
}

// Enter the field names followed by comma
func (r RecordaAPIPutRequest) ReturnFields(returnFields string) RecordaAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r RecordaAPIPutRequest) ReturnFields2(returnFields2 string) RecordaAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r RecordaAPIPutRequest) ReturnAsObject(returnAsObject int32) RecordaAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r RecordaAPIPutRequest) MaxResults(maxResults int32) RecordaAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r RecordaAPIPutRequest) Method(method string) RecordaAPIPutRequest {
	r.method = &method
	return r
}

func (r RecordaAPIPutRequest) Execute() (*ListRecordAResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a record:a object
	...
	@return RecordaAPIPutRequest
*/
func (a *RecordaAPIService) Put(ctx context.Context) RecordaAPIPutRequest {
	return RecordaAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListRecordAResponse
func (a *RecordaAPIService) PutExecute(r RecordaAPIPutRequest) (*ListRecordAResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "RecordaAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
