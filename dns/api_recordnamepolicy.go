...
type RecordnamepolicyAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a recordnamepolicy object

		Use PUT call as GET operation with _method for a Struct field of a recordnamepolicy object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return RecordnamepolicyAPIPutRequest
	*/
	Put(ctx context.Context) RecordnamepolicyAPIPutRequest

	// PutExecute executes the request
	//  @return ListRecordnamepolicyResponse
	PutExecute(r RecordnamepolicyAPIPutRequest) (*ListRecordnamepolicyResponse, *http.Response, error)
	/*
...
type RecordnamepolicyAPIPutRequest struct {
	ctx              context.Context
	ApiService       RecordnamepolicyAPI
	recordnamepolicy *Recordnamepolicy
	returnFields     *string
...
// Object data to create
func (r RecordnamepolicyAPIPutRequest) Recordnamepolicy(recordnamepolicy Recordnamepolicy) RecordnamepolicyAPIPutRequest {
	r.recordnamepolicy = &recordnamepolicy
	return r
}

// Enter the field names followed by comma
func (r RecordnamepolicyAPIPutRequest) ReturnFields(returnFields string) RecordnamepolicyAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r RecordnamepolicyAPIPutRequest) ReturnFields2(returnFields2 string) RecordnamepolicyAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r RecordnamepolicyAPIPutRequest) ReturnAsObject(returnAsObject int32) RecordnamepolicyAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r RecordnamepolicyAPIPutRequest) MaxResults(maxResults int32) RecordnamepolicyAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r RecordnamepolicyAPIPutRequest) Method(method string) RecordnamepolicyAPIPutRequest {
	r.method = &method
	return r
}

func (r RecordnamepolicyAPIPutRequest) Execute() (*ListRecordnamepolicyResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a recordnamepolicy object
	...
	@return RecordnamepolicyAPIPutRequest
*/
func (a *RecordnamepolicyAPIService) Put(ctx context.Context) RecordnamepolicyAPIPutRequest {
	return RecordnamepolicyAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListRecordnamepolicyResponse
func (a *RecordnamepolicyAPIService) PutExecute(r RecordnamepolicyAPIPutRequest) (*ListRecordnamepolicyResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "RecordnamepolicyAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
