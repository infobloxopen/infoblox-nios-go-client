...
type ZoneAuthAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a zone_auth object

		Use PUT call as GET operation with _method for a Struct field of a zone_auth object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return ZoneAuthAPIPutRequest
	*/
	Put(ctx context.Context) ZoneAuthAPIPutRequest

	// PutExecute executes the request
	//  @return ListZoneAuthResponse
	PutExecute(r ZoneAuthAPIPutRequest) (*ListZoneAuthResponse, *http.Response, error)
	/*
...
type ZoneAuthAPIPutRequest struct {
	ctx            context.Context
	ApiService     ZoneAuthAPI
	zoneAuth       *ZoneAuth
	returnFields   *string
...
// Object data to create
func (r ZoneAuthAPIPutRequest) ZoneAuth(zoneAuth ZoneAuth) ZoneAuthAPIPutRequest {
	r.zoneAuth = &zoneAuth
	return r
}

// Enter the field names followed by comma
func (r ZoneAuthAPIPutRequest) ReturnFields(returnFields string) ZoneAuthAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r ZoneAuthAPIPutRequest) ReturnFields2(returnFields2 string) ZoneAuthAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r ZoneAuthAPIPutRequest) ReturnAsObject(returnAsObject int32) ZoneAuthAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r ZoneAuthAPIPutRequest) MaxResults(maxResults int32) ZoneAuthAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r ZoneAuthAPIPutRequest) Method(method string) ZoneAuthAPIPutRequest {
	r.method = &method
	return r
}

func (r ZoneAuthAPIPutRequest) Execute() (*ListZoneAuthResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a zone_auth object
	...
	@return ZoneAuthAPIPutRequest
*/
func (a *ZoneAuthAPIService) Put(ctx context.Context) ZoneAuthAPIPutRequest {
	return ZoneAuthAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListZoneAuthResponse
func (a *ZoneAuthAPIService) PutExecute(r ZoneAuthAPIPutRequest) (*ListZoneAuthResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "ZoneAuthAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
