...
type ZoneDelegatedAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a zone_delegated object

		Use PUT call as GET operation with _method for a Struct field of a zone_delegated object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return ZoneDelegatedAPIPutRequest
	*/
	Put(ctx context.Context) ZoneDelegatedAPIPutRequest

	// PutExecute executes the request
	//  @return ListZoneDelegatedResponse
	PutExecute(r ZoneDelegatedAPIPutRequest) (*ListZoneDelegatedResponse, *http.Response, error)
	/*
...
type ZoneDelegatedAPIPutRequest struct {
	ctx            context.Context
	ApiService     ZoneDelegatedAPI
	zoneDelegated  *ZoneDelegated
	returnFields   *string
...
// Object data to create
func (r ZoneDelegatedAPIPutRequest) ZoneDelegated(zoneDelegated ZoneDelegated) ZoneDelegatedAPIPutRequest {
	r.zoneDelegated = &zoneDelegated
	return r
}

// Enter the field names followed by comma
func (r ZoneDelegatedAPIPutRequest) ReturnFields(returnFields string) ZoneDelegatedAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r ZoneDelegatedAPIPutRequest) ReturnFields2(returnFields2 string) ZoneDelegatedAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r ZoneDelegatedAPIPutRequest) ReturnAsObject(returnAsObject int32) ZoneDelegatedAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r ZoneDelegatedAPIPutRequest) MaxResults(maxResults int32) ZoneDelegatedAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r ZoneDelegatedAPIPutRequest) Method(method string) ZoneDelegatedAPIPutRequest {
	r.method = &method
	return r
}

func (r ZoneDelegatedAPIPutRequest) Execute() (*ListZoneDelegatedResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a zone_delegated object
	...
	@return ZoneDelegatedAPIPutRequest
*/
func (a *ZoneDelegatedAPIService) Put(ctx context.Context) ZoneDelegatedAPIPutRequest {
	return ZoneDelegatedAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListZoneDelegatedResponse
func (a *ZoneDelegatedAPIService) PutExecute(r ZoneDelegatedAPIPutRequest) (*ListZoneDelegatedResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "ZoneDelegatedAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
