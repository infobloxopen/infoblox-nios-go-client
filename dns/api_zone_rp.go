...
type ZoneRpAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a zone_rp object

		Use PUT call as GET operation with _method for a Struct field of a zone_rp object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return ZoneRpAPIPutRequest
	*/
	Put(ctx context.Context) ZoneRpAPIPutRequest

	// PutExecute executes the request
	//  @return ListZoneRpResponse
	PutExecute(r ZoneRpAPIPutRequest) (*ListZoneRpResponse, *http.Response, error)
	/*
...
type ZoneRpAPIPutRequest struct {
	ctx            context.Context
	ApiService     ZoneRpAPI
	zoneRp         *ZoneRp
	returnFields   *string
...
// Object data to create
func (r ZoneRpAPIPutRequest) ZoneRp(zoneRp ZoneRp) ZoneRpAPIPutRequest {
	r.zoneRp = &zoneRp
	return r
}

// Enter the field names followed by comma
func (r ZoneRpAPIPutRequest) ReturnFields(returnFields string) ZoneRpAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r ZoneRpAPIPutRequest) ReturnFields2(returnFields2 string) ZoneRpAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r ZoneRpAPIPutRequest) ReturnAsObject(returnAsObject int32) ZoneRpAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r ZoneRpAPIPutRequest) MaxResults(maxResults int32) ZoneRpAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r ZoneRpAPIPutRequest) Method(method string) ZoneRpAPIPutRequest {
	r.method = &method
	return r
}

func (r ZoneRpAPIPutRequest) Execute() (*ListZoneRpResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a zone_rp object
	...
	@return ZoneRpAPIPutRequest
*/
func (a *ZoneRpAPIService) Put(ctx context.Context) ZoneRpAPIPutRequest {
	return ZoneRpAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListZoneRpResponse
func (a *ZoneRpAPIService) PutExecute(r ZoneRpAPIPutRequest) (*ListZoneRpResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "ZoneRpAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
