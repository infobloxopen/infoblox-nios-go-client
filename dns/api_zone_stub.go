...
type ZoneStubAPI interface {
	...
	*/
	...
	/*
		Put Use PUT call as GET operation with _method for a Struct field of a zone_stub object

		Use PUT call as GET operation with _method for a Struct field of a zone_stub object

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@return ZoneStubAPIPutRequest
	*/
	Put(ctx context.Context) ZoneStubAPIPutRequest

	// PutExecute executes the request
	//  @return ListZoneStubResponse
	PutExecute(r ZoneStubAPIPutRequest) (*ListZoneStubResponse, *http.Response, error)
	/*
...
type ZoneStubAPIPutRequest struct {
	ctx            context.Context
	ApiService     ZoneStubAPI
	zoneStub       *ZoneStub
	returnFields   *string
...
// Object data to create
func (r ZoneStubAPIPutRequest) ZoneStub(zoneStub ZoneStub) ZoneStubAPIPutRequest {
	r.zoneStub = &zoneStub
	return r
}

// Enter the field names followed by comma
func (r ZoneStubAPIPutRequest) ReturnFields(returnFields string) ZoneStubAPIPutRequest {
	r.returnFields = &returnFields
	return r
}

// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r ZoneStubAPIPutRequest) ReturnFields2(returnFields2 string) ZoneStubAPIPutRequest {
	r.returnFields2 = &returnFields2
	return r
}

// Select 1 if result is required as an object
func (r ZoneStubAPIPutRequest) ReturnAsObject(returnAsObject int32) ZoneStubAPIPutRequest {
	r.returnAsObject = &returnAsObject
	return r
}

// Enter the number of results to be fetched
func (r ZoneStubAPIPutRequest) MaxResults(maxResults int32) ZoneStubAPIPutRequest {
	r.maxResults = &maxResults
	return r
}

// Enter the method type for the request
func (r ZoneStubAPIPutRequest) Method(method string) ZoneStubAPIPutRequest {
	r.method = &method
	return r
}

func (r ZoneStubAPIPutRequest) Execute() (*ListZoneStubResponse, *http.Response, error) {
...
Use PUT call as GET operation with _method for a Struct field of a zone_stub object
	...
	@return ZoneStubAPIPutRequest
*/
func (a *ZoneStubAPIService) Put(ctx context.Context) ZoneStubAPIPutRequest {
	return ZoneStubAPIPutRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListZoneStubResponse
func (a *ZoneStubAPIService) PutExecute(r ZoneStubAPIPutRequest) (*ListZoneStubResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "ZoneStubAPIService.Put")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}
