...
`func (o *GetAllrecordsResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetAllrecordsResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetAllrecordsResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetAllrecordsResponse) HasUuid() bool`
