...
`func (o *GetDdnsPrincipalclusterResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDdnsPrincipalclusterResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDdnsPrincipalclusterResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDdnsPrincipalclusterResponse) HasUuid() bool`
