...
`func (o *GetNsgroupDelegationResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetNsgroupDelegationResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetNsgroupDelegationResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetNsgroupDelegationResponse) HasUuid() bool`
