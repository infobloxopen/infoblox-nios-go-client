...
`func (o *GetNsgroupForwardingmemberResponse) SetExtAttrsPlus(v map[string]ExtAttrs)`
...
`func (o *GetNsgroupForwardingmemberResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetNsgroupForwardingmemberResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetNsgroupForwardingmemberResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetNsgroupForwardingmemberResponse) HasUuid() bool`
