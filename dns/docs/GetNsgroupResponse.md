...
`func (o *GetNsgroupResponse) GetExtAttrsPlus() map[string]ExtAttrs`
...
`func (o *GetNsgroupResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetNsgroupResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetNsgroupResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetNsgroupResponse) HasUuid() bool`
