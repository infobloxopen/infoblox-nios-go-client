...
`func (o *GetRecordAResponse) HasExtAttrsMinus() bool`
...
`func (o *GetRecordAResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordAResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordAResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordAResponse) HasUuid() bool`
