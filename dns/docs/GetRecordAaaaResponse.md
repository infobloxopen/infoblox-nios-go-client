...
`func (o *GetRecordAaaaResponse) HasExtAttrsMinus() bool`
...
`func (o *GetRecordAaaaResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordAaaaResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordAaaaResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordAaaaResponse) HasUuid() bool`
