...
`func (o *GetRecordAliasResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordAliasResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordAliasResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordAliasResponse) HasUuid() bool`
