...
`func (o *GetRecordCaaResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordCaaResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordCaaResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordCaaResponse) HasUuid() bool`
