...
`func (o *GetRecordNaptrResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordNaptrResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordNaptrResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordNaptrResponse) HasUuid() bool`
