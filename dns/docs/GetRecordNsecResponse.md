...
`func (o *GetRecordNsecResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordNsecResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordNsecResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordNsecResponse) HasUuid() bool`
