...
`func (o *GetSharedrecordAResponse) SetExtAttrsPlus(v map[string]ExtAttrs)`
...
`func (o *GetSharedrecordAResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordAResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordAResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordAResponse) HasUuid() bool`
