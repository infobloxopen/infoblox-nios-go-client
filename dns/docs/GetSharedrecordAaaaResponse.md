...
`func (o *GetSharedrecordAaaaResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordAaaaResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordAaaaResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordAaaaResponse) HasUuid() bool`
