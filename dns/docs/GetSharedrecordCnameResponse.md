...
`func (o *GetSharedrecordCnameResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordCnameResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordCnameResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordCnameResponse) HasUuid() bool`
