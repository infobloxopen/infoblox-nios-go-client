...
`func (o *GetSharedrecordMxResponse) SetExtAttrsMinus(v map[string]ExtAttrs)`
...
`func (o *GetSharedrecordMxResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordMxResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordMxResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordMxResponse) HasUuid() bool`
