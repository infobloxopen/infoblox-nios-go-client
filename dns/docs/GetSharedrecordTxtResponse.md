...
`func (o *GetSharedrecordTxtResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordTxtResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordTxtResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordTxtResponse) HasUuid() bool`
