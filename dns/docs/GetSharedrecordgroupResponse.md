...
`func (o *GetSharedrecordgroupResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSharedrecordgroupResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSharedrecordgroupResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSharedrecordgroupResponse) HasUuid() bool`
