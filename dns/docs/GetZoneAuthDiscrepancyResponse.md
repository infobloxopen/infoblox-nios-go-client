...
`func (o *GetZoneAuthDiscrepancyResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetZoneAuthDiscrepancyResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetZoneAuthDiscrepancyResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetZoneAuthDiscrepancyResponse) HasUuid() bool`
