...
**Nsec3SaltMinLength** | Pointer to **int64** | The minimum length for NSEC3 salts. RFC 9276 recommends empty salt (0 octets) for optimal resolver compatibility and reduced computational overhead. | [optional] 
**Nsec3SaltMaxLength** | Pointer to **int64** | The maximum length for NSEC3 salts. RFC 9276 recommends empty salt (0 octets) for optimal resolver compatibility and reduced computational overhead. | [optional] 
**Nsec3Iterations** | Pointer to **int64** | The number of iterations used for hashing NSEC3. RFC 9276 Section 3.1 mandates that this value MUST be set to zero (0) to ensure DNSSEC resolver compatibility and alleviate computational burdens on validating resolvers. | [optional] 
