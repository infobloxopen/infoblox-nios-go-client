...
func (o *RecordDname) UnmarshalJSON(data []byte) (err error) {
	varRecordDname := _RecordDname{}

	err = json.Unmarshal(data, &varRecordDname)

	if err != nil {
		return err
	}

	*o = RecordDname(varRecordDname)
