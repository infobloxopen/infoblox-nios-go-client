...
func (o *RecordDs) UnmarshalJSON(data []byte) (err error) {
	varRecordDs := _RecordDs{}

	err = json.Unmarshal(data, &varRecordDs)

	if err != nil {
		return err
	}

	*o = RecordDs(varRecordDs)
