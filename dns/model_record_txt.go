...
func (o *RecordTxt) UnmarshalJSON(data []byte) (err error) {
	varRecordTxt := _RecordTxt{}

	err = json.Unmarshal(data, &varRecordTxt)

	if err != nil {
		return err
	}

	*o = RecordTxt(varRecordTxt)
