...
`func (o *DtcTopologyRulesInner) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *DtcTopologyRulesInner) GetUuidOk() (*string, bool)`
...
`func (o *DtcTopologyRulesInner) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *DtcTopologyRulesInner) HasUuid() bool`
