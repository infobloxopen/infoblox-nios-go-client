...
`func (o *GetDtcMonitorPdpResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDtcMonitorPdpResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDtcMonitorPdpResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDtcMonitorPdpResponse) HasUuid() bool`
