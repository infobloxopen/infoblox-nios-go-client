...
`func (o *GetDtcMonitorResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDtcMonitorResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDtcMonitorResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDtcMonitorResponse) HasUuid() bool`
