...
`func (o *GetDtcMonitorSipResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDtcMonitorSipResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDtcMonitorSipResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDtcMonitorSipResponse) HasUuid() bool`
