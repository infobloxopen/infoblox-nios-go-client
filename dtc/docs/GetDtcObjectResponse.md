...
`func (o *GetDtcObjectResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDtcObjectResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDtcObjectResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDtcObjectResponse) HasUuid() bool`
