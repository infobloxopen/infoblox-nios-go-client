...
`func (o *GetDtcResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDtcResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDtcResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDtcResponse) HasUuid() bool`
