...
func (r FedipamopAPIListRequest) ReturnFields2(returnFields2 string) FedipamopAPIListRequest {
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r FedipamopAPIReadRequest) ReturnFields2(returnFields2 string) FedipamopAPIReadRequest {
	r.returnFields2 = &returnFields2
	return r
}
