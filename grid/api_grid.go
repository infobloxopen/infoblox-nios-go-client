...
func (r GridAPIListRequest) ReturnFields2(returnFields2 string) GridAPIListRequest {
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r GridAPIReadRequest) ReturnFields2(returnFields2 string) GridAPIReadRequest {
	r.returnFields2 = &returnFields2
	return r
}
...
// Enter the field names followed by comma, this returns the required fields along with the default fields
func (r GridAPIUpdateRequest) ReturnFields2(returnFields2 string) GridAPIUpdateRequest {
	r.returnFields2 = &returnFields2
	return r
}
