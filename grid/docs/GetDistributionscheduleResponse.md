...
`func (o *GetDistributionscheduleResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetDistributionscheduleResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetDistributionscheduleResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetDistributionscheduleResponse) HasUuid() bool`
