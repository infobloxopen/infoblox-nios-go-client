...
`func (o *GetGridCloudapiVmResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetGridCloudapiVmResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetGridCloudapiVmResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetGridCloudapiVmResponse) HasUuid() bool`
