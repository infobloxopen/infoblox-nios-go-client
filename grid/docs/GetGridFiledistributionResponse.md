...
`func (o *GetGridFiledistributionResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetGridFiledistributionResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetGridFiledistributionResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetGridFiledistributionResponse) HasUuid() bool`
