...
`func (o *GetGridX509certificateResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetGridX509certificateResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetGridX509certificateResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetGridX509certificateResponse) HasUuid() bool`
