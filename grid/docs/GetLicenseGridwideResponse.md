...
`func (o *GetLicenseGridwideResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetLicenseGridwideResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetLicenseGridwideResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetLicenseGridwideResponse) HasUuid() bool`
