...
`func (o *GetMemberLicenseResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetMemberLicenseResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetMemberLicenseResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetMemberLicenseResponse) HasUuid() bool`
