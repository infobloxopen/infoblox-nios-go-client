...
`func (o *GetMemberdfpResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetMemberdfpResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetMemberdfpResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetMemberdfpResponse) HasUuid() bool`
