...
`func (o *GetUpgradescheduleResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetUpgradescheduleResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetUpgradescheduleResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetUpgradescheduleResponse) HasUuid() bool`
