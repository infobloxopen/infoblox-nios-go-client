...
`func (o *GetHostnamerewritepolicyResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetHostnamerewritepolicyResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetHostnamerewritepolicyResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetHostnamerewritepolicyResponse) HasUuid() bool`
