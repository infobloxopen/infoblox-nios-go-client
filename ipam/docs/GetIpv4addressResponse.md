...
`func (o *GetIpv4addressResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetIpv4addressResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetIpv4addressResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetIpv4addressResponse) HasUuid() bool`
