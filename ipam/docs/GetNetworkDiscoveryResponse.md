...
`func (o *GetNetworkDiscoveryResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetNetworkDiscoveryResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetNetworkDiscoveryResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetNetworkDiscoveryResponse) HasUuid() bool`
