...
`func (o *GetNetworktemplateResponse) GetLeaseScavengeTime() string`

GetLeaseScavengeTime returns the LeaseScavengeTime field if non-nil, zero value otherwise.

### GetLeaseScavengeTimeOk

`func (o *GetNetworktemplateResponse) GetLeaseScavengeTimeOk() (*string, bool)`
...
`func (o *GetNetworktemplateResponse) SetLeaseScavengeTime(v string)`
