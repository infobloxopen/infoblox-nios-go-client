...
**DdnsZonePrimaries** | Pointer to [**[]NetworkviewDdnsZonePrimaries**](NetworkviewDdnsZonePrimaries.md) | An array of Ddns Zone Primary dhcpddns structs that lists the information of primary zone to which DDNS updates should be sent. | [optional] 
...
`func (o *GetNetworkviewResponse) GetExtAttrsMinusOk() (*map[string]ExtAttrs, bool)`
