...
`func (o *GetVlanResponse) GetId() VlanId`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *GetVlanResponse) GetIdOk() (*VlanId, bool)`
...
`func (o *GetVlanResponse) SetId(v VlanId)`
...
`func (o *GetVlanResponse) GetFuncCall() FuncCall`

GetFuncCall returns the FuncCall field if non-nil, zero value otherwise.

### GetFuncCallOk

`func (o *GetVlanResponse) GetFuncCallOk() (*FuncCall, bool)`
...
`func (o *GetVlanResponse) SetFuncCall(v FuncCall)`

SetFuncCall sets FuncCall field to given value.

### HasFuncCall

`func (o *GetVlanResponse) HasFuncCall() bool`
...
`func (o *GetVlanResponse) GetParent() VlanParent`

GetParent returns the Parent field if non-nil, zero value otherwise.

### GetParentOk

`func (o *GetVlanResponse) GetParentOk() (*VlanParent, bool)`
...
`func (o *GetVlanResponse) SetParent(v VlanParent)`
