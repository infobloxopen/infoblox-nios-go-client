...
func main() {
	msserverAdsitesSite := *microsoft.NewMsserverAdsitesSite() // MsserverAdsitesSite | Object data to create
...
func main() {
	reference := "reference_example" // string | Reference of the msserver:adsites:site object
	msserverAdsitesSite := *microsoft.NewMsserverAdsitesSite() // MsserverAdsitesSite | Object data to update
