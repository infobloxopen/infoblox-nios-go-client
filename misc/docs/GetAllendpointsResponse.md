...
`func (o *GetAllendpointsResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetAllendpointsResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetAllendpointsResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetAllendpointsResponse) HasUuid() bool`
