...
`func (o *GetCsvimporttaskResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetCsvimporttaskResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetCsvimporttaskResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetCsvimporttaskResponse) HasUuid() bool`
