...
`func (o *GetFileopResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetFileopResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetFileopResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetFileopResponse) HasUuid() bool`
