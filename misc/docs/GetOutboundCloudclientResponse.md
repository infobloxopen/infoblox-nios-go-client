...
`func (o *GetOutboundCloudclientResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetOutboundCloudclientResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetOutboundCloudclientResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetOutboundCloudclientResponse) HasUuid() bool`
