...
`func (o *GetSearchResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetSearchResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetSearchResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetSearchResponse) HasUuid() bool`
