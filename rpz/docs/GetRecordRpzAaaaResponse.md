...
`func (o *GetRecordRpzAaaaResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzAaaaResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzAaaaResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzAaaaResponse) HasUuid() bool`
