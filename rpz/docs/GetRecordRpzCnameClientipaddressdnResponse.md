# GetRecordRpzCnameClientipaddressdnResponse
...
**IsIpv4** | Pointer to **bool** | Indicates whether the record is an IPv4 record. If the return value is \&quot;true\&quot;, it is an IPv4 record. Otherwise, it is an IPv6 record. | [optional] [readonly] 
...
`func (o *GetRecordRpzCnameClientipaddressdnResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzCnameClientipaddressdnResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzCnameClientipaddressdnResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzCnameClientipaddressdnResponse) HasUuid() bool`
...
`func (o *GetRecordRpzCnameClientipaddressdnResponse) GetExtAttrsOk() (*map[string]ExtAttrs, bool)`
...
`func (o *GetRecordRpzCnameClientipaddressdnResponse) SetName(v string)`
