...
`func (o *GetRecordRpzCnameResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzCnameResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzCnameResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzCnameResponse) HasUuid() bool`
