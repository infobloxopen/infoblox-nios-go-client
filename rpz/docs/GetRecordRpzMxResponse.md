...
`func (o *GetRecordRpzMxResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzMxResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzMxResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzMxResponse) HasUuid() bool`
