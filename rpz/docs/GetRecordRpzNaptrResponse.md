...
`func (o *GetRecordRpzNaptrResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzNaptrResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzNaptrResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzNaptrResponse) HasUuid() bool`
