...
`func (o *GetRecordRpzPtrResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzPtrResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzPtrResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzPtrResponse) HasUuid() bool`
