...
`func (o *GetRecordRpzTxtResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRecordRpzTxtResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRecordRpzTxtResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRecordRpzTxtResponse) HasUuid() bool`
