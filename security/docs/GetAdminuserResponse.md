...
`func (o *GetAdminuserResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetAdminuserResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetAdminuserResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetAdminuserResponse) HasUuid() bool`
