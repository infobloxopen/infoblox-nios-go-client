...
`func (o *GetHsmAllgroupsResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetHsmAllgroupsResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetHsmAllgroupsResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetHsmAllgroupsResponse) HasUuid() bool`
