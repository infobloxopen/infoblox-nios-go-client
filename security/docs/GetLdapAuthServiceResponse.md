...
`func (o *GetLdapAuthServiceResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetLdapAuthServiceResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetLdapAuthServiceResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetLdapAuthServiceResponse) HasUuid() bool`
