...
`func (o *GetRadiusAuthserviceResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetRadiusAuthserviceResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetRadiusAuthserviceResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetRadiusAuthserviceResponse) HasUuid() bool`
