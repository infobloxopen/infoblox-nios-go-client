...
`func (o *GetTacacsplusAuthserviceResponse) GetCheckTacacsplusServerSettings() map[string]interface{}`
...
`func (o *GetTacacsplusAuthserviceResponse) GetCheckTacacsplusServerSettingsOk() (*map[string]interface{}, bool)`
...
`func (o *GetTacacsplusAuthserviceResponse) SetCheckTacacsplusServerSettings(v map[string]interface{})`

SetCheckTacacsplusServerSettings sets CheckTacacsplusServerSettings field to given value.

### HasCheckTacacsplusServerSettings

`func (o *GetTacacsplusAuthserviceResponse) HasCheckTacacsplusServerSettings() bool`
