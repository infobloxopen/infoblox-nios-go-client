...
`func (o *GetTacacsplusAuthserviceResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetTacacsplusAuthserviceResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetTacacsplusAuthserviceResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetTacacsplusAuthserviceResponse) HasUuid() bool`
