...
`func (o *GetUserprofileResponse) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *GetUserprofileResponse) GetUuidOk() (*string, bool)`
...
`func (o *GetUserprofileResponse) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *GetUserprofileResponse) HasUuid() bool`
