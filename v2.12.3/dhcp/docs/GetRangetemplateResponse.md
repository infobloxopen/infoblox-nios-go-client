...
`func (o *GetRangetemplateResponse) GetLeaseScavengeTime() string`

GetLeaseScavengeTime returns the LeaseScavengeTime field if non-nil, zero value otherwise.

### GetLeaseScavengeTimeOk

`func (o *GetRangetemplateResponse) GetLeaseScavengeTimeOk() (*string, bool)`
...
`func (o *GetRangetemplateResponse) SetLeaseScavengeTime(v string)`
