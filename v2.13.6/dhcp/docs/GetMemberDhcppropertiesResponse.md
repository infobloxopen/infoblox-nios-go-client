...
**ClearNacAuthCache** | Pointer to **map[string]interface{}** |  | [optional] 
...
`func (o *GetMemberDhcppropertiesResponse) GetPurgeIfmapDataOk() (*map[string]interface{}, bool)`
