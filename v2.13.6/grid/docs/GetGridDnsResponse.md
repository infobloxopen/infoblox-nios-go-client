...
`func (o *GetGridDnsResponse) GetBulkHostNameTemplates() []map[string]interface{}`
...
`func (o *GetGridDnsResponse) GetBulkHostNameTemplatesOk() (*[]map[string]interface{}, bool)`
...
`func (o *GetGridDnsResponse) SetBulkHostNameTemplates(v []map[string]interface{})`
...
`func (o *GetGridDnsResponse) GetGssTsigKeys() []map[string]interface{}`

GetGssTsigKeys returns the GssTsigKeys field if non-nil, zero value otherwise.

### GetGssTsigKeysOk

`func (o *GetGridDnsResponse) GetGssTsigKeysOk() (*[]map[string]interface{}, bool)`
...
`func (o *GetGridDnsResponse) SetGssTsigKeys(v []map[string]interface{})`
...
`func (o *GetGridDnsResponse) GetProtocolRecordNamePolicies() []map[string]interface{}`
...
`func (o *GetGridDnsResponse) GetProtocolRecordNamePoliciesOk() (*[]map[string]interface{}, bool)`
...
`func (o *GetGridDnsResponse) SetProtocolRecordNamePolicies(v []map[string]interface{})`
