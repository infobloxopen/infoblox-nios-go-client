...
`func (o *GetIpv6networkcontainerResponse) GetEndpointSources() []map[string]interface{}`

GetEndpointSources returns the EndpointSources field if non-nil, zero value otherwise.

### GetEndpointSourcesOk

`func (o *GetIpv6networkcontainerResponse) GetEndpointSourcesOk() (*[]map[string]interface{}, bool)`
...
`func (o *GetIpv6networkcontainerResponse) SetEndpointSources(v []map[string]interface{})`
...
`func (o *GetIpv6networkcontainerResponse) GetNextAvailableNetwork() map[string]interface{}`

GetNextAvailableNetwork returns the NextAvailableNetwork field if non-nil, zero value otherwise.

### GetNextAvailableNetworkOk

`func (o *GetIpv6networkcontainerResponse) GetNextAvailableNetworkOk() (*map[string]interface{}, bool)`
...
`func (o *GetIpv6networkcontainerResponse) SetNextAvailableNetwork(v map[string]interface{})`

SetNextAvailableNetwork sets NextAvailableNetwork field to given value.

### HasNextAvailableNetwork

`func (o *GetIpv6networkcontainerResponse) HasNextAvailableNetwork() bool`
